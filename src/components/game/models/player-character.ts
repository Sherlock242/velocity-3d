...
export function createPlayerCharacter(
  ...
  leftArmGroup.position.set(shoulderWidth + 0.2, torso.position.y + shoulderHeight, 0);
  ...
  rightArmGroup.position.set(-(shoulderWidth + 0.2), torso.position.y + shoulderHeight, 0);
