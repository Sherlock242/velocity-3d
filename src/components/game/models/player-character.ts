...
export function createPlayerCharacter(
  ...
  leftArmGroup.position.set(shoulderWidth + 0.1, torso.position.y + shoulderHeight, 0);
  ...
  rightArmGroup.position.set(-(shoulderWidth + 0.1), torso.position.y + shoulderHeight, 0);
