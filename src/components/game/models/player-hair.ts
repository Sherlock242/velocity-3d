...
export function createHair(headRadius: number, hairMaterial: THREE.Material) {
    ...
    const layers = [
        ...
        { count: 10000, length: 0.35, width: 0.15, yRange: [0.1, 0.8], zRange: [-0.8, 0.6], xRange: [-1.0, 1.0], rotX: 1.2, seed: 1 },
        // Smaller side layer
        ...
        { count: 1500, length: 0.25, width: 0.05, yRange: [-0.3, 0.2], zRange: [0.7, 0.9], xRange: [-0.7, 0.7], rotX: 1.8, seed: 4 },
    ];
