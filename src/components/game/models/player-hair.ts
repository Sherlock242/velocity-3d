...
export function createHair(headRadius: number, hairMaterial: THREE.Material) {
    ...
    const layers = [
        ...
        { count: 3200, length: 0.2, width: 0.1, yRange: [-0.31, 0.5], zRange: [-1.0, 0.0], xRange: [-0.85, 0.85], rotX: 1.0, seed: 1 },
        // Smaller side layer
        { count: 2400, length: 0.18, width: 0.09, yRange: [-0.2, 0.6], zRange: [-0.2, 0.2], xRange: [-0.9, 0.9], rotX: 1.1, seed: 2 },
