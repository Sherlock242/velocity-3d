    ...
    for (let j = 0; j < GRID_SIZE; j++) {
      ...
      switch (sectorNumber) {
        ...
        case 3:
          ...
          break;
        case 4:
          sectorGroup = createSector4({ cellCenterX, cellCenterZ, staticCollidersRef, walkableSurfacesRef, gltfLoader: gltfLoaderRef.current!, isSector4LoadedRef, forestGroundRef });
          break;
        case 10:
